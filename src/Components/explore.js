...
export default class MyGallery extends React.Component {
    ...
    loadData = (page) => {
        ...
        axios({
            method:'get',
            url:'https://api.flickr.com/services/rest/?method=flickr.interestingness.getList&api_key='+flickr.api_key+'&format=json&nojsoncallback=1&per_page=20&page=0',
            params: {
                page: page
            },
            responseType:'json'
            ...
            for(var i in photoInfo){
                ...
                axios({
                    ...
                    photoDetail.push(result.data.photo);
                })
            }
